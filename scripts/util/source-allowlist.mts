 ...
 *   workflow produce these bytes?". Both must hold.
 *
 * @see ./pack-app-triplets.mts for `PackAppTriplet`.
 * @see Fleet plan `publishing-ultrathink-acorn-audit.md` for the topology.
 */
